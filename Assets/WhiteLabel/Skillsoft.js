if (document.querySelector('link[href^="/css/exam-result/result.css"]') == null) {
    ...
    // Skillsoft customization
    $(".supportIcon").remove();
  
    let a = document.createElement('a');  
    let link = document.createTextNode("Submit a support request to Skillsoft"); 
    a.appendChild(link);  
    a.title = "Skillsoft Support";  
    a.href = "https://support.skillsoft.com/";
    a.target= '_blank';
  
    let ul = document.getElementsByClassName('iconLinksList')[0]
    let li = document.createElement("li")
    li.appendChild(a);
    li.setAttribute("class", "newIcon");
    ul.appendChild(li);
